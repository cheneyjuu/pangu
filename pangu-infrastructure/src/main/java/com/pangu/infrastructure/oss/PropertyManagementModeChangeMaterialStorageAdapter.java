// 关联业务：复用私有 OSS 能力保存物业管理模式变更决议和辅助证据材料。
...
public class PropertyManagementModeChangeMaterialStorageAdapter implements PropertyManagementModeChangeMaterialStorage {
