...
public interface RepairProjectMapper {
    ...
    int freezePlanForAuthorization(@Param("planId") Long planId,
                                   ...
                                   @Param("constructionManagementRequirements") String constructionManagementRequirements,
                                   @Param("evidenceRequirementsJson") String evidenceRequirementsJson,
                                   @Param("safetyRequirements") String safetyRequirements,
                                   @Param("settlementMethod") String settlementMethod,
                                   @Param("plannedStartDate") java.time.LocalDate plannedStartDate,
                                   @Param("plannedCompletionDate") java.time.LocalDate plannedCompletionDate,
                                   @Param("warrantyDays") Integer warrantyDays,
