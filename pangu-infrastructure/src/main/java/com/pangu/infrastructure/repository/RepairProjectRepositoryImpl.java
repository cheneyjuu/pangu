...
public class RepairProjectRepositoryImpl implements RepairProjectRepository {
    ...
    public int freezePlanForAuthorization(
        ...
        return mapper.freezePlanForAuthorization(
                ...
                proposal.nonCompetitiveSelectionBasis(), proposal.constructionManagementRequirements(),
                writeJson(proposal.evidenceRequirements()), proposal.safetyRequirements(),
                nameOrNull(proposal.settlementMethod()), proposal.plannedStartDate(),
                proposal.plannedCompletionDate(), proposal.warrantyDays(), proposal.acceptanceMethod(),
