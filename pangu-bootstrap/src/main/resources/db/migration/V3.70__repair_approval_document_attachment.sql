...
COMMENT ON COLUMN t_repair_attachment.attachment_kind IS
    'INTAKE_ATTACHMENT=登记工单附件；LOCATION_IMAGE=位置证据；SURVEY_IMAGE/SURVEY_VIDEO=初勘证据；QUOTE_DOCUMENT=报价原件；APPROVAL_DOCUMENT=物业正式报审文件；SOLITAIRE_SCREENSHOT=微信接龙截图';
