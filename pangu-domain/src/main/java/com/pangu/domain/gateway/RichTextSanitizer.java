...
public interface RichTextSanitizer {
    ...
    record SanitizedRichText(String html, String plainText, Set<Long> narrativeImageIds) {

        public SanitizedRichText {
            narrativeImageIds = narrativeImageIds == null ? Set.of() : Set.copyOf(narrativeImageIds);
        }
